...
l = [[l0 for j in range(int(mapHeight/gridHeight))] for i in range(int(mapWidth/gridWidth))]
...
posesFile = open("Data/poses.txt", 'r')
measurementFile = open("Data/measurement.txt", 'r')
measurementData = []
...
while True:
    ...
    result = occupancyGridMapping(robotX, robotY, (robotTheta / 10) * (math.pi / 180), measurementData)
